...
export const metadata: Metadata = {
  title: 'Global AIIT - Generative AI, ML & Data Science Engineering Courses',
  description: 'Master Generative AI, Large Language Models (LLMs), MLOps, Data Science, and Cloud Architecture with enterprise industry architects.',
  generator: 'v0.app',
