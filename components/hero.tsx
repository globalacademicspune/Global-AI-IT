    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-10">
          ...
          {/* Announcement Badges Container - REARRANGED */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10">
            
            {/* LEFT: Online Demo */}
            <Link href="/career-roadmap" className="inline-block transition-transform hover:scale-105 active:scale-95 animate-pulse [animation-delay:0.2s]">
              ...
              border border-blue-200 shadow-sm flex items-center gap-2">
                <Video size={16} className="text-blue-600" />
                Online Demo: 26th Jan 2026 @ 3PM
              </div>
            </Link>

            {/* MIDDLE: Republic Week Offer (Main Highlight) */}
            <Link href="/career-roadmap" className="inline-block transition-transform hover:scale-110 active:scale-95 animate-pulse">
              ...
              text-white px-6 py-2.5 rounded-full text-sm md:text-base font-black 
              border-2 border-orange-300 shadow-[0_0_20px_rgba(234,88,12,0.4)] flex items-center gap-2">
                <Sparkles size={20} className="animate-spin-slow" />
                Republic Week Offer: Flat 50% OFF
              </div>
            </Link>

            {/* RIGHT: Offline Demo */}
            <Link href="/career-roadmap" className="inline-block transition-transform hover:scale-105 active:scale-95 animate-pulse [animation-delay:0.4s]">
              <div className="bg-gradient-to-r from-emerald-100 to-teal-100 
              text-emerald-800 px-4 py-2 rounded-full text-xs md:text-sm font-semibold 
              border border-emerald-200 shadow-sm flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-12">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4 border border-white/20">
              ...
              <div className="text-sm text-white/60">Industry Trainers</div>
            </div>
          </div>
