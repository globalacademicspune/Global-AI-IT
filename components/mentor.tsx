  ...
  return (
    <section className="py-20 bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="bg-white/10 border-white/20 backdrop-blur-sm mentor-card">
          <div className="p-8 md:p-12 space-y-6">

            <div>
              <h3 className="text-3xl font-bold mb-2">Zuber Shaikh</h3>
              <p className="text-lg">500k+ Followers on LinkedIn, YouTube & Twitter</p>
            </div>
            ...
            <p className="text-base leading-relaxed border-t border-white/20 pt-6">
